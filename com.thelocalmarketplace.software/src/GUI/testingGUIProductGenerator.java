...
public class testingGUIProductGenerator {
	...
	public testingGUIProductGenerator(String productName, String codeLength, int productMass, int price, int inventory) {
			//for pluCode
			String temp = "";
			...
			for (int i = 0; i < codeLength.length(); i++) {
				...
				temp += String.valueOf((Character.getNumericValue(parsedString)) % 10);
